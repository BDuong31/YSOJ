...
# Cấu hình broker URL sử dụng Redis
CELERY_BROKER_URL = 'redis://localhost:6379/0'  # Kết nối đến Redis tại localhost:6379, sử dụng database 0

# Cấu hình backend sử dụng Redis (tùy chọn)
